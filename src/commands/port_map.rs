//! Port mapping command implementations
...
pub async fn port_map(protocol: &str, local_port: NonZeroU16, timeout: Duration) -> Result<()> {
...
/// Probes a port map.
pub async fn port_map_probe(config: portmapper::Config) -> Result<()> {
