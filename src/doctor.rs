...
pub fn configure_local_relay_map() -> RelayMap {
...
pub fn create_secret_key(secret_key: SecretKeyOption) -> anyhow::Result<SecretKey> {
    Ok(match secret_key {
...
pub async fn run(
    ...
    let cmd_res = match command {
        ...
        Commands::Plot {
            ...
            commands::plot::run_plot(interval, metrics, timeframe, scrape_url, file).await
        }
